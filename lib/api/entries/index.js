...
function configure (app, wares, ctx, env) {
  ...
  function ifModifiedSinceCTX (req, res, next) {
    ...
    console.log(`CGM Entry request with If-Modified-Since: ${new Date(ifModifiedSince).toISOString()}, (new is ${new Date().toDateString()}, last is ${lastEntryDate.toDateString().toISOString()})`);
